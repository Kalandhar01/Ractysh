...
function ExecutionDashboard() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 opacity-70" style={{ backgroundImage: "url('/HeaderBG.png')", backgroundSize: "cover", backgroundPosition: "center" }} />
  ...
  return (
    <section className="px-5 py-12 md:px-8 md:py-16">
      <div className="mx-auto max-w-[1120px]">
        ...
        >
          <div className="absolute inset-0 opacity-[0.34]" style={{ backgroundImage: "url('/HeaderBG.png')", backgroundSize: "cover", backgroundPosition: "center" }} />
