  ...
  async function onSubmit(values: ConsultationFormValues) {
    ...
    try {
      ...
      if (result?.consultation?._id && result.consultation.trackingToken) {
        ...
        window.dispatchEvent(new CustomEvent("ractysh-consultation-submitted", { detail: result.consultation }));
      }
      reset({
        fullName: "",
        companyName: "",
    ...
    <section id="consultation-form" className="relative px-5 pb-0 pt-[4.5rem] md:px-8 md:pb-0 md:pt-24">
      ...
      <div className="mx-auto max-w-[82rem]">
        ...
        <AnimatePresence mode="wait">
          ...
          <div className="mt-6 flex flex-col gap-4 border-t border-[#e7dfd1] pt-5 md:flex-row md:items-center md:justify-between">
            <div className="min-h-6 text-[13px] font-medium text-[#706b62]/80">Private consultation desk</div>
            <Button
              type="submit"
              disabled={isSubmitting}
