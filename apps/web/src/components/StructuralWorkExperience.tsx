...
import { ArrowRight, Building2, CheckCircle2, Grid3X3, Ruler, ShieldCheck } from "lucide-react";
  ...
  return (
    ...
    >
      <motion.div animate={reduceMotion ? undefined : { y: [0, -10, 0] }} transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}>
        ...
        >
        <div className="absolute inset-0 opacity-75" style={{ backgroundImage: "url('/HeaderBG.png')", backgroundSize: "cover", backgroundPosition: "center" }} />
