...
const disclosureSections: LegalEditorialSection[] = [
  ...
  },
  {
    ...
    body:
      "Architecture, construction, real estate, export-import and OTC exchange workflows may depend on site conditions, authority approvals, specialist consultants, vendors, logistics partners, documentation readiness, counterparty suitability and third-party timelines that sit outside a single published page."
  },
  {
    id: "estimates",
  ...
  },
  {
    ...
    body:
      "Ractysh may coordinate with external vendors, consultants, logistics providers, technology platforms and approval bodies. Their services, timelines, licensing standards and operational availability remain governed by their own controls and obligations."
  },
  {
    id: "accuracy",
