    ...
    >
      ...
      <div className="mx-auto grid max-w-[88rem] items-center gap-14 lg:grid-cols-[minmax(0,1fr)_1px_minmax(0,1fr)] lg:gap-14 xl:gap-16">
        ...
        >
          ...
          <h2 className="font-cormorant mt-7 max-w-[43rem] text-[3.05rem] font-semibold leading-[0.96] tracking-normal text-[#20140f] sm:text-[4.05rem] lg:text-[4.3rem] xl:text-[4.55rem]">
          ...
          <p className="mt-8 max-w-[35rem] text-[1rem] font-medium leading-[1.9] tracking-normal text-[#6b5d4f] md:text-[1.08rem]">
