        ...
        ? createPortal(
          ...
          >
            ...
            <motion.div
              ...
              initial={reduceMotion ? false : { opacity: 0, y: 20, scale: 0.96, filter: "blur(10px)" }}
              animate={reduceMotion ? undefined : { opacity: 1, y: 0, scale: 1, filter: "blur(0px)" }}
              exit={reduceMotion ? undefined : { opacity: 0, y: 14, scale: 0.97, filter: "blur(6px)" }}
              ...
              <AnimatePresence mode="wait">
                {status === "success" ? (
                  ...
                  >
                    ...
                    <h3 className="mt-6 [font-family:var(--font-cormorant)] text-[2rem] font-semibold leading-none text-[#17120f]">
                      Request delivered.
                    </h3>
                  ...
                  >
                    <div className="pr-10">
                      ...
                      <h2
                        ...
                        className="mt-3 max-w-[26rem] [font-family:var(--font-cormorant)] text-[2.35rem] font-semibold leading-[0.94] tracking-normal text-[#17120f] sm:text-[2.65rem]"
                      >
