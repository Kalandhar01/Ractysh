...
const divisionConfig = {
  "import-export": {
    ...
    subtext:
      "Import, export, enterprise logistics and cross-border commerce systems are currently being expanded into a dedicated operational platform.",
    ctaLabel: "Notify Me",
    Icon: Globe2,
    ...
    signals: ["Cargo route", "Port window", "Supplier sync", "Logistics line"],
    metrics: [
