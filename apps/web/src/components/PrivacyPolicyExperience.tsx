        ...
        <section className="relative z-10 px-5 pb-14 pt-32 md:px-8 md:pb-16 lg:pt-40">
          <div className="mx-auto max-w-[1000px]">
            <Reveal>
              ...
              <h1 className="mt-5 [font-family:var(--font-cormorant)] text-[clamp(3.4rem,8vw,7rem)] font-semibold leading-[0.9] tracking-[-0.02em] text-[#18130f]">
                Privacy Policy
              </h1>
            ...
            <div className="mt-4">
              {privacySections.map((section, index) => (
                <Reveal key={section.title} delay={Math.min(index * 0.03, 0.14)} className="border-t border-[#c9a85a]/24 py-8 first:mt-4">
                  <h2 className="[font-family:var(--font-cormorant)] text-[2rem] font-semibold leading-tight text-[#1b1511] md:text-[2.45rem]">
                    {section.title}
                  </h2>
