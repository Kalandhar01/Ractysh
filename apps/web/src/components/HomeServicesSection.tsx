...
const serviceDivisions: ServiceDivision[] = [
  ...
  },
  {
    ...
    imageClassName: "object-[50%_50%]",
    code: "TRD",
    capabilities: ["Global Sourcing", "Supplier Network", "Trade Logistics", "International Movement"]
  },
  {
    title: "OTC Exchange",
...
export function HomeServicesSection() {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      gsap.set(introItems, { opacity: 0, y: 36, filter: "blur(10px)", force3D: true });
      gsap.set(panels, {
        opacity: 0,
        xPercent: 42,
        scale: 0.93,
      ...
      gsap.set(panelCopyItems.flat(), { opacity: 0, y: 28, filter: "blur(8px)", force3D: true });
      ...
      gsap.set(finalCopy, { opacity: 0, y: 22, filter: "blur(8px)", force3D: true });
  ...
  return (
    ...
    >
      ...
      <div
        data-services-final
        className="absolute inset-0 z-30 flex flex-col justify-end overflow-hidden bg-[#070606]/92 px-3 pb-16 pt-32 opacity-0 motion-reduce:relative motion-reduce:inset-auto motion-reduce:mt-10 motion-reduce:opacity-100 sm:px-5 md:px-8 md:pb-24"
      >
        ...
        <div className="relative z-10 mx-auto mb-6 flex w-full max-w-[94rem] flex-col gap-3 md:mb-7 md:flex-row md:items-end md:justify-between">
          <div>
