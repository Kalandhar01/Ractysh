...
type ApplicationFieldName = "fullName" | "email" | "phone" | "portfolio" | "message" | "resume";
const formFieldNames = ["fullName", "email", "phone", "portfolio", "message", "resume"] as const;
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-md flex-col items-center">
        ...
        <motion.h3
          ...
          className="mt-3 font-cormorant text-[28px] font-semibold leading-[1.08] tracking-normal text-[#181512] md:text-[36px]"
        >
...
export function CareerApplicationModal({
  ...
  async function onSubmit(values: ApplicationFormValues) {
    ...
    try {
      ...
      payload.append("portfolio", values.portfolio);
                ...
                <div className="flex items-start justify-between gap-5">
                  <div>
                    ...
                    <h2
                      ...
                      className="mt-3 font-cormorant text-[30px] font-semibold leading-[1.04] tracking-normal text-[#181512] md:text-[40px]"
                    >
                      {title}
                    </h2>
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        ...
                        >
                          <input
                            ...
                            aria-describedby={errors.portfolio ? "careerPortfolio-error" : undefined}
                            className={fieldClass(errors.portfolio?.message)}
                            {...register("portfolio")}
                          />
                        </ApplicationField>
