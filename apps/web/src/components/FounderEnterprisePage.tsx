...
import founderPortrait from "../../../../Founder.png";
...
const timelineSteps = [
  ...
  },
  {
    ...
    description:
      "Global trade coordination, logistics planning and enterprise supply systems shaped for modern commercial operations.",
    Icon: Globe2
  },
  {
  ...
  return (
    <div ref={rootRef} className="relative isolate overflow-hidden bg-[#f8f1e4] text-[#1c120e]">
      ...
      <section
        id="hero"
        data-founder-hero
        className="relative z-10 min-h-[100svh] overflow-hidden bg-[#080604] text-[#fff7e8]"
      >
        <motion.div
        ...
        >
          <div ref={portraitRef} className="absolute inset-[-4%]">
            <Image
              src={founderPortrait}
              alt={portraitAlt}
              fill
              ...
              quality={88}
              sizes="100vw"
              className="object-cover object-[58%_28%] grayscale contrast-[1.13] brightness-[0.86] saturate-[0.86]"
            />
          </div>
        </motion.div>
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_60%_34%,transparent_0%,rgba(8,6,4,0.18)_42%,rgba(8,6,4,0.9)_100%),linear-gradient(90deg,rgba(8,6,4,0.96)_0%,rgba(8,6,4,0.72)_31%,rgba(8,6,4,0.14)_62%,rgba(8,6,4,0.62)_100%),linear-gradient(180deg,rgba(8,6,4,0.72)_0%,transparent_28%,rgba(8,6,4,0.88)_100%)]"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 opacity-[0.22] [background-image:radial-gradient(circle_at_1px_1px,rgba(240,219,177,0.26)_1px,transparent_0)] [background-size:18px_18px]"
        />
        <span
          aria-hidden="true"
        ...
        <motion.div
          ...
          className="absolute right-5 top-[6.25rem] z-30 grid h-14 w-14 place-items-center rounded-full border border-[#d9bd7a]/52 bg-[#100b08]/58 shadow-[0_18px_52px_rgba(0,0,0,0.34),0_0_24px_rgba(217,189,122,0.08)] backdrop-blur-md sm:right-8 sm:top-[6.75rem] sm:h-[5.1rem] sm:w-[5.1rem]"
        >
        ...
        <div className="relative z-20 mx-auto flex min-h-[100svh] w-full max-w-[92rem] items-end px-5 pb-12 pt-[7.25rem] md:px-8 md:pb-16 xl:px-12 xl:pb-20">
          <div data-founder-identity-overlay className="max-w-[42rem] pb-1 md:pb-4 xl:pb-7">
            <motion.p
              initial={{ opacity: 0, y: 22, filter: "blur(8px)" }}
              animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
              transition={{ duration: 0.78, delay: 0.64, ease: motionEase }}
              className="text-[0.72rem] font-bold uppercase leading-none tracking-[0] text-[#d7c08b] drop-shadow-[0_8px_20px_rgba(0,0,0,0.45)] sm:text-[0.78rem] md:text-[0.82rem]"
            >
              {founderRole}
            </motion.p>
            ...
            <motion.h1
              ...
              className="mt-4 max-w-[38rem] bg-[linear-gradient(112deg,#fff5df_0%,#e2c98d_29%,#b88d49_52%,#f8ead0_73%,#caa762_100%)] bg-clip-text font-display text-[2.1rem] font-semibold uppercase leading-[0.95] tracking-[0] text-transparent drop-shadow-[0_14px_34px_rgba(0,0,0,0.5)] sm:text-[2.7rem] md:text-[3.28rem] lg:text-[3.72rem] xl:text-[4.05rem]"
            >
              {founderName}
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-5 max-w-[31rem] !font-display text-[1.22rem] font-medium leading-[1.18] tracking-[0] text-[#f4e4c2] drop-shadow-[0_10px_24px_rgba(0,0,0,0.48)] sm:text-[1.4rem] md:text-[1.62rem]"
            >
              {founderSubtitle}
            </motion.p>
          </div>
      ...
      <section className="relative z-10 px-5 pb-8 pt-16 md:px-8 lg:pb-10 lg:pt-[5.5rem]">
        ...
        >
          ...
          <p className="mx-auto max-w-[50rem] font-display text-[22px] font-semibold leading-[1.1] tracking-[-0.035em] text-[#fff7e8] md:text-[28px] lg:text-[34px]">
