    ...
    >
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[1440px] items-center gap-16 lg:min-h-screen lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:gap-16 xl:gap-20">
        ...
        >
          ...
          <h2 className="mle-heading mt-8 max-w-[46rem] font-cormorant text-[3.55rem] font-semibold leading-[0.95] tracking-[0] text-[#181411] sm:text-[4.55rem] lg:text-[4.85rem] xl:text-[5.2rem]">
            <span className="block">One Ecosystem.</span>
            <span className="block">Endless Possibilities.</span>
          </h2>

          <p className="mt-8 max-w-[29rem] font-manrope text-[1rem] font-medium leading-[1.85] text-[#5b5146] sm:text-[1.08rem]">
