        ...
        <section className="relative z-10 px-5 pb-14 pt-32 md:px-8 md:pb-16 lg:pt-40">
          <div className="mx-auto max-w-[1000px] text-center">
            <Reveal>
              ...
              <h1 className="mx-auto mt-5 max-w-[820px] text-[3.45rem] font-semibold leading-[0.92] text-[#18130f] [font-family:var(--font-cormorant)] sm:text-[4.5rem] md:text-[5.6rem] lg:text-[6.5rem]">
                {document.title}
              </h1>
                ...
                {sections.map((section, index) => (
                  <Reveal key={section.id} delay={Math.min(index * 0.025, 0.12)} className="border-b border-[#c8a65d]/22 last:border-b-0">
                    <section id={section.id} className="scroll-mt-28 px-5 py-8 md:px-10 md:py-10">
                      ...
                      <h2 className="mt-3 text-[2.05rem] font-semibold leading-tight text-[#1b1511] [font-family:var(--font-cormorant)] md:text-[2.65rem]">
                        {section.title}
                      </h2>
