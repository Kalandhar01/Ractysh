  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[88rem]">
        ...
        >
          <h1 className="mx-auto max-w-[60rem] text-5xl font-semibold leading-[0.92] tracking-[-0.04em] text-[#181614] [font-family:var(--font-cormorant)] md:text-6xl lg:text-7xl">
            <span>Our Recent </span>
            <span className="text-[#c7a763]">Works</span>
          </h1>
          <p className="mx-auto mt-7 max-w-[42rem] text-[0.78rem] font-normal leading-[1.95] tracking-[0.08em] text-[rgba(67,61,54,0.64)] [font-family:var(--font-manrope)] sm:text-[0.86rem]">
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 text-[#fffaf1] sm:p-7">
                  <div className="translate-y-2 transition duration-700 ease-out group-hover:translate-y-0">
                    <h2 className="text-[1.46rem] font-medium leading-[1.12] tracking-normal drop-shadow-[0_12px_30px_rgba(0,0,0,0.34)] [font-family:var(--font-cormorant)] sm:text-[1.72rem]">
                      {project.title}
                    </h2>
                    <p className="mt-2.5 text-[0.68rem] font-normal leading-[1.7] tracking-normal text-[rgba(255,248,237,0.56)]">{project.location}</p>
                  </div>
                </div>
                <div className="absolute left-6 top-6 rounded-full border border-white/30 bg-[rgba(255,255,255,0.12)] px-3 py-1 text-[0.54rem] font-medium uppercase leading-none tracking-normal text-[rgba(255,255,255,0.62)] shadow-[0_12px_30px_rgba(0,0,0,0.18)] backdrop-blur-[8px]">
                  {project.category}
                </div>
              </motion.article>
            ))}
