...
export function HeroHeading({ hero, isReady }: HeroHeadingProps) {
  void hero;
  ...
  return (
    <div className={cn("hero-copy mx-auto max-w-[72rem] text-center", isReady ? "opacity-100" : "opacity-0")}>
      <div
        data-hero-eyebrow
      ...
      <h1
        ...
        className="mx-auto max-w-[72rem] font-display text-[calc(2.35rem-1px)] font-medium leading-[1.03] tracking-normal text-[#303030] sm:text-[calc(2.75rem-1px)] md:text-[calc(3rem-1px)] lg:text-[calc(3.35rem-1px)] xl:text-[calc(4rem-1px)]"
      >
        {headlineLines.map((line, lineIndex) => (
          <span key={lineIndex} className="block overflow-hidden pb-[0.035em]">
