        ...
        <section className="relative z-10 px-5 pb-20 pt-36 text-center md:px-8 md:pb-24 lg:pb-28 lg:pt-44">
          <div className="mx-auto max-w-[920px]">
            <Reveal className="mx-auto">
              ...
              <h1 className="mx-auto mt-7 max-w-[52rem] [font-family:var(--font-cormorant)] text-[clamp(4.5rem,10vw,9.4rem)] font-semibold leading-[0.82] tracking-normal text-[#17110d]">
                Terms &amp;
                ...
                {termsSections.map((section, index) => (
                  <Reveal key={section.id} delay={Math.min(index * 0.018, 0.09)} className="border-t border-[#c8a65d]/24 py-10 first:mt-7 md:py-12">
                    <section id={section.id} data-terms-section className="scroll-mt-28">
                      ...
                      <h2 className="mt-4 [font-family:var(--font-cormorant)] text-[2.2rem] font-semibold leading-[1.02] tracking-normal text-[#18120e] md:text-[2.9rem]">
                        {section.title}
                      </h2>
