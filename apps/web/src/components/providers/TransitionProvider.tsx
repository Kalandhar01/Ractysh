    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          initial={reduceMotion ? { opacity: 1 } : { opacity: 0, scale: 0.992, filter: "blur(10px)" }}
          animate={
            reduceMotion
              ? { opacity: 1 }
              : { opacity: 1, scale: 1, filter: "blur(0px)", transition: { duration: 0.46, ease: premiumEase } }
          }
          exit={
            reduceMotion
              ? { opacity: 0 }
              : { opacity: 0, scale: 1.03, filter: "blur(16px)", transition: { duration: 0.9, ease: premiumEase } }
          }
          style={{
