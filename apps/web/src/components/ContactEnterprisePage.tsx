...
import { ArrowRight, Building2, CheckCircle2, Globe2, Mail, MapPin, type LucideIcon } from "lucide-react";
...
export function ContactEnterprisePage({ location }: ContactEnterprisePageProps) {
  ...
  const email = location?.email || "hello@ractysh.com";
  const phone = location?.phone || "+91 90000 00000";
  const address = location?.address || "Premium business district, India";
  const contactDetails = [
    { Icon: Mail, label: "Email", value: email, href: `mailto:${email}` },
    { Icon: Building2, label: "Enterprise Desk", value: phone, href: `tel:${phone}` },
    { Icon: Globe2, label: "Operations", value: "Five-pillar enterprise ecosystem" },
        ...
        <div className="mx-auto grid w-full max-w-[1420px] gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(28rem,1fr)] lg:items-center xl:gap-14">
          <div className="mx-auto max-w-[43rem] text-center lg:mx-0 lg:text-left">
            ...
            <h1
              ...
              className="mt-7 text-[2.75rem] font-semibold leading-[0.96] text-[#17130f] [font-family:var(--font-cormorant)] sm:text-[4.15rem] sm:leading-[0.9] lg:text-[4.55rem] xl:text-[4.8rem]"
            >
      ...
      <section className="relative z-10 px-5 py-24 sm:px-6 md:px-8 lg:py-32">
        <div className="mx-auto grid w-full max-w-[1320px] gap-14 lg:grid-cols-[minmax(18rem,0.72fr)_minmax(0,1.28fr)] lg:gap-20">
          ...
          >
            ...
            <h2 className="mt-5 max-w-[31rem] text-[2.7rem] font-semibold leading-[0.98] text-[#18130f] [font-family:var(--font-cormorant)] sm:text-[3.8rem]">
            ...
            <div className="mb-8 flex flex-col gap-5 border-b border-[#b99446]/22 pb-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-[1.45rem] font-semibold leading-none text-[#18130f] [font-family:var(--font-cormorant)]">
                    Private Intake
                  </h2>
                </div>
              </div>
