...
-- CreateEnum
CREATE TYPE "WorkflowAdminAction" AS ENUM ('approve', 'reject', 'move_next', 'add_note', 'update_status', 'upload_response');
...
CREATE TABLE "AdminAction" (
    ...
    "stageId" TEXT,
    "stageKey" "WorkflowStageKey",
    "action" "WorkflowAdminAction" NOT NULL,
    "statusBefore" TEXT,
    "statusAfter" TEXT,
    "notes" TEXT,
    "adminId" TEXT,
...
-- CreateIndex
CREATE INDEX "AdminAction_consultationId_createdAt_idx" ON "AdminAction"("consultationId", "createdAt");

-- CreateIndex
CREATE INDEX "AdminAction_stageId_idx" ON "AdminAction"("stageId");
...
-- AddForeignKey
ALTER TABLE "AdminAction" ADD CONSTRAINT "AdminAction_consultationId_fkey" FOREIGN KEY ("consultationId") REFERENCES "Consultation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdminAction" ADD CONSTRAINT "AdminAction_stageId_fkey" FOREIGN KEY ("stageId") REFERENCES "WorkflowStage"("id") ON DELETE SET NULL ON UPDATE CASCADE;
