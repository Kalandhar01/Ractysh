...
export const seedContent: SiteContent = {
  ...
  divisions: [
    ...
    },
    {
      ...
      services: ["Import & Export Operations", "Global Trade Coordination", "Enterprise Logistics", "Cross-Border Commerce"],
      metric: "Global trade"
    }
  ],
  services: [
    {
      title: "Import & Export",
      description: "Enterprise-grade import, export and international logistics coordination for modern business ecosystems.",
